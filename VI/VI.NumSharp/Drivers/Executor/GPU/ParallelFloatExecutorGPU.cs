...
namespace VI.NumSharp.Drivers.Executor.GPU
{
    ...
    public partial class ParallelFloatExecutorGPU 
    {
        Action<Index, ArrayView<float>, ArrayView<float>, ArrayView<float>> _V_mult_V;
        Action<Index, ArrayView<float>, ArrayView<float>, ArrayView<float>> _V_div_V;
        Action<Index, ArrayView<float>, ArrayView<float>, ArrayView<float>> _V_sub_V;
        Action<Index, ArrayView<float>, ArrayView<float>, ArrayView<float>> _V_add_V;
        Action<Index, ArrayView<float>, ArrayView<float>, float> _V_add_C;
        Action<Index, ArrayView<float>, ArrayView<float>, float> _V_mult_C;
        Action<Index, ArrayView<float>, ArrayView<float>, float> _V_sub_C;
        Action<Index, ArrayView<float>, float, ArrayView<float>> _C_sub_V;
        Action<Index, ArrayView<float>, ArrayView<float>, float> _V_div_C;
        Action<Index, ArrayView<float>, float, ArrayView<float>> _C_div_V;
        Action<Index, ArrayView<float>, ArrayView<float>, ArrayView<byte>> _V_ApplyMask;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Tanh;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Sin;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Cos;
        Action<Index, ArrayView<float>, ArrayView<float>, float> _V_Pow;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Exp;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Log;
        Action<Index, ArrayView<float>, ArrayView<float>> _V_Sqrt;
        Action<Index2, ArrayView2D<float>, ArrayView<float>, ArrayView2D<float>> _VT_mult_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _M_mult_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _M_div_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _M_sub_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _M_add_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView<float>> _M_mult_VT;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView<float>> _M_mult_V;
        Action<Index2, ArrayView2D<float>, ArrayView<float>, ArrayView2D<float>> _V_mult_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, float> _M_mult_C;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, float> _M_add_C;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, float> _M_div_C;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, float> _C_div_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, int> _IC_div_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>> _m_Sqrt;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _M_mult_MT;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<float>> _MT_mult_M;
        Action<Index2, ArrayView2D<float>, ArrayView2D<float>, ArrayView2D<byte>> _M_ApplyMask;
        Action<Index2, ArrayView2D<float>, int, int> _M_SumLine;
        Action<Index2, ArrayView2D<float>, int, int> _M_SumColumn;
        Action<Index, ArrayView<float>, ArrayView2D<float>> _M_2_lines_V;
        Action<Index, ArrayView<float>, ArrayView2D<float>> _M_2_columns_V;
        Action<Index2, ArrayView2D<float>, ArrayView<float>, ArrayView<float>> _VT_mult_V;
        Action<Index2, ArrayView2D<float>, ArrayView<float>, ArrayView<float>> _V_mult_VT;
