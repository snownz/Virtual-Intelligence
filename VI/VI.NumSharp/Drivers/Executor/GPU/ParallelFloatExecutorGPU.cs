...
namespace VI.NumSharp.Drivers.Executor.GPU
{
	public class ParallelFloatExecutorGPU : IFloatArrayExecutor
	{
		...
		{
			var size   = v0.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_mult_V"].Launch(size, cache.MemoryView, v0.MemoryView, v1.MemoryView);
			return cache;
		}
		public IFloatData V_div_V(IFloatData cache, IFloatData v0, IFloatData v1)
		{
			var size   = v0.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_div_V"].Launch(size, cache.MemoryView, v0.MemoryView, v1.MemoryView);
			return cache;
		}
		public IFloatData V_sub_V(IFloatData cache, IFloatData v0, IFloatData v1)
		{
			var size   = v0.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_sub_V"].Launch(size, cache.MemoryView, v0.MemoryView, v1.MemoryView);
			return cache;
		}
		public IFloatData V_add_V(IFloatData cache, IFloatData v0, IFloatData v1)
		{
			var size   = v0.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_add_V"].Launch(size, cache.MemoryView, v0.MemoryView, v1.MemoryView);
            return cache;
        }
		public IFloatData V_add_C(IFloatData cache, IFloatData v, float c)
		{
			var size   = v.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_add_C"].Launch(size, cache.MemoryView, v.MemoryView, c);
            return cache;
		...
		{
			var size   = v.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_mult_C"].Launch(size, cache.MemoryView, v.MemoryView, c);
            return cache;
		...
		{
			var size   = v.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_sub_C"].Launch(size, cache.MemoryView, v.MemoryView, c);
            return cache;
        }
		...
		{
			var size   = v.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_div_C"].Launch(size, cache.MemoryView, v.MemoryView, c);
            return cache;
        }
		...
		{
			var size = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Tanh"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
		public IFloatData Sin(IFloatData cache, IFloatData arr)
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Sin"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
		...
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Cos"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
		public IFloatData Pow(IFloatData cache, IFloatData arr, float exp)
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Pow"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
		public IFloatData Exp(IFloatData cache, IFloatData arr)
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Exp"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
		public IFloatData Log(IFloatData cache, IFloatData arr)
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Log"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
		public IFloatData Sqrt(IFloatData cache, IFloatData arr)
		{
			var size   = arr.Length;
			ProcessingDevice.FloatArrayDevice.Executor["V_Sqrt"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }		
		...
		public IFloatData2D VT_mult_M(IFloatData2D cache, IFloatData vt, IFloatData2D m)
		{
			...
			ProcessingDevice.FloatArrayDevice.Executor["VT_mult_M"].Launch(size, cache.MemoryView, vt.MemoryView, m.MemoryView);
            return cache;
        }
		public IFloatData2D M_mult_M(IFloatData2D cache, IFloatData2D m0, IFloatData2D m1)
		{
			var size   = new Index2(m0.W, m0.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_mult_M"].Launch(size, cache.MemoryView, m0.MemoryView, m1.MemoryView);
            return cache;
        }
		public IFloatData2D M_div_M(IFloatData2D cache, IFloatData2D m0, IFloatData2D m1)
		{
			var size   = new Index2(m0.W, m0.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_div_M"].Launch(size, cache.MemoryView, m0.MemoryView, m1.MemoryView);
            return cache;
        }
		public IFloatData2D M_sub_M(IFloatData2D cache, IFloatData2D m0, IFloatData2D m1)
		{
			var size   = new Index2(m0.W, m0.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_sub_M"].Launch(size, cache.MemoryView, m0.MemoryView, m1.MemoryView);
            return cache;
        }
		public IFloatData2D M_add_M(IFloatData2D cache, IFloatData2D m0, IFloatData2D m1)
		{
			var size   = new Index2(m0.W, m0.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_add_M"].Launch(size, cache.MemoryView, m0.MemoryView, m1.MemoryView);
            return cache;
        }
		public IFloatData2D M_mult_VT(IFloatData2D cache, IFloatData2D m, IFloatData v)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_mult_VT"].Launch(size, cache.MemoryView, m.MemoryView, v.MemoryView);
            return cache;
        }
		public IFloatData2D M_mult_V(IFloatData2D cache, IFloatData2D m, IFloatData v)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_mult_V"].Launch(size, cache.MemoryView, m.MemoryView, v.MemoryView);
            return cache;
        }
		public IFloatData2D V_mult_M(IFloatData2D cache, IFloatData v, IFloatData2D m)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["V_mult_M"].Launch(size, cache.MemoryView, v.MemoryView, m.MemoryView);
            return cache;
        }
		public IFloatData2D M_mult_C(IFloatData2D cache, IFloatData2D m, float c)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_mult_C"].Launch(size, cache.MemoryView, m.MemoryView, c);
            return cache;
        }
		public IFloatData2D M_add_C(IFloatData2D cache, IFloatData2D m, float c)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_add_C"].Launch(size, cache.MemoryView, m.MemoryView, c);
            return cache;
        }
		public IFloatData2D M_div_C(IFloatData2D cache, IFloatData2D m, float c)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["M_div_C"].Launch(size, cache.MemoryView, m.MemoryView, c);
            return cache;
        }
		public IFloatData2D C_div_M(IFloatData2D cache, IFloatData2D m, float c)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["C_div_M"].Launch(size, cache.MemoryView, m.MemoryView, c);
            return cache;
        }
		public IFloatData2D C_div_M(IFloatData2D cache, IFloatData2D m, int c)
		{
			var size   = new Index2(m.W, m.H);
			ProcessingDevice.FloatArrayDevice.Executor["IC_div_M"].Launch(size, cache.MemoryView, m.MemoryView, c);
            return cache;
        }			
		public IFloatData2D Sqrt(IFloatData2D cache, IFloatData2D arr)
		{
			var size   = new Index2(arr.W, arr.H);
			ProcessingDevice.FloatArrayDevice.Executor["m_Sqrt"].Launch(size, cache.MemoryView, arr.MemoryView);
            return cache;
        }
        ...
        public IFloatData2D VT_mult_V(IFloatData vt, IFloatData v)
        {
            ...
            ProcessingDevice.FloatArrayDevice.Executor["VT_mult_V"].Launch(size, output.View, vt.MemoryView, v.MemoryView);
        ...
        public IFloatData2D V_mult_VT(IFloatData v, IFloatData vt)
        {
            var size = new Index2(v.Length, vt.Length);
            var output = ILGPUMethods.Allocate<float>(size);
            ProcessingDevice.FloatArrayDevice.Executor["V_mult_VT"].Launch(size, output.View, v.MemoryView, vt.MemoryView);
            return new GPU_FloatData2D(output);
        }
        public IFloatData2D M_mult_MT(IFloatData2D m, IFloatData2D mt)
        {
            var size = new Index2(m.W, m.H);
            var output = ILGPUMethods.Allocate<float>(size);
            ProcessingDevice.FloatArrayDevice.Executor["M_mult_MT"].Launch(size, output.View, m.MemoryView, mt.MemoryView);
            return new GPU_FloatData2D(output);
        }
        public IFloatData2D MT_mult_M(IFloatData2D mt, IFloatData2D m)
        {
            ...
            var output = ILGPUMethods.Allocate<float>(size);
            ProcessingDevice.FloatArrayDevice.Executor["MT_mult_M"].Launch(size, output.View, mt.MemoryView, m.MemoryView);
            return new GPU_FloatData2D(output);
        }
        public IFloatData ApplyMask(IFloatData arr, IByteData mask)
        {
            var size = arr.Length;
            ProcessingDevice.FloatArrayDevice.Executor["V_ApplyMask"].Launch(size, arr.MemoryView, arr.MemoryView, mask.View);
            return arr;
        }
        public IFloatData2D ApplyMask(IFloatData2D arr, IByteData2D mask)
        {
            var size = new Index2(arr.W, arr.H);
            ProcessingDevice.FloatArrayDevice.Executor["M_ApplyMask"].Launch(size, arr.MemoryView, arr.MemoryView, mask.View);
            return arr;
