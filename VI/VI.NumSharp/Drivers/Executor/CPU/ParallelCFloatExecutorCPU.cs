...
namespace VI.NumSharp.Drivers.Executor.CPU
{
    partial class ParallelCFloatExecutorCPU
    {
        ...
        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_V_sub_C(int len, float[] cache, float c, float[] v);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_V_div_C(int len, float[] cache, float[] v, float c);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void _V_div_C(int len, float[] cache, float c, float[] v);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Tanh(int len, float[] cache, float[] arr);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void  C_Sin(int len, float[] cache, float[] arr);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Cos(int len, float[] cache, float[] arr);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Pow(int len, float[] cache, float[] arr, float exp);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Exp(int len, float[] cache, float[] arr);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Log(int len, float[] cache, float[] arr);

        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Sqrt(int len, float[] cache, float[] arr);
        ...
        [DllImport("VI.Core.Cpu", CallingConvention = CallingConvention.Cdecl)]
        public static extern void C_Sqrt(int w, int h, float[,] cache, float[,] arr);
    ...
    {   
        ...
        {
            C_Sqrt(cache.W, cache.H, cache.View, arr.View);
            return cache;
        }
