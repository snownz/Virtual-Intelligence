...
namespace VI.NumSharp.Prototypes.ANN
{
    public class LSTMNetwork
    {
        ...
        public void UpdateParams(FloatArray2D dWf, FloatArray2D dWi, FloatArray2D dWc, FloatArray2D dWo, FloatArray2D dWv, FloatArray dBf, FloatArray dBi, FloatArray dBc, FloatArray dBo, FloatArray dBv)
        {
            // memoria Adagrad
            mWf += (dWf * dWf);
            mWi += (dWi * dWi);
