...
namespace VI.Maths.Array
{
    public static class ArrayOperations
    {
        ...
        public static void _M_2_lines_V(Index size, ArrayView2D<float> v, ArrayView2D<float> m)
        {
            int x = size.X;
        ...
        public static void _M_sum_M(Index2 size, ArrayView2D<float> m0, ArrayView2D<float> m1, ArrayView2D<float> m2)
        {
            int x = size.X;
            int y = size.Y;
        ...
        public static void _V_sum_V(Index size, ArrayView<float> v0, ArrayView<float> v1, ArrayView<float> v2)
        {
            int x = size.X;
