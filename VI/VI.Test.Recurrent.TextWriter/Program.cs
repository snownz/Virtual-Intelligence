...
namespace VI.Test.Recurrent.TextWriter
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            net = new ClassifierRecurrentNeuralNetwork(vocab_size, vocab_size, hidden_size, recurrentUnits, learning_rate, 1e-1f);

            var hprev = new Array<FloatArray>(recurrentUnits){ [-1] = new FloatArray(hidden_size) };
            ...
            while (1 == 1)
            {
                ...
                {
                    hprev = new Array<FloatArray>(recurrentUnits){[-1] = new FloatArray(hidden_size)};
                    p = 0;
                }
